 ...
 * @return proton_status_e return status
 */
  static inline proton_status_e proton_fill_frame_header(
    uint8_t * header, const uint16_t payload_len)
  {
    if (!header)
    {
      return PROTON_NULL_PTR_ERROR;
 ...
 * @return proton_status_e return status
 */
  static inline proton_status_e proton_fill_crc16(
 ...
 * @return proton_status_e return status
 */
  static inline proton_status_e proton_check_framed_payload(
 ...
 * @return proton_status_e return status
 */
  static inline proton_status_e proton_get_framed_payload_length(
