...
proton_status_e proton_node_node2_transport_connect(void * context)
{
  ...
  c->sock_recv = socket_init(
    PROTON__NODE__NODE3__ENDPOINT__1__IPHL, PROTON__NODE__NODE3__ENDPOINT__1__PORT, true);
  c->sock_send = socket_init(
    PROTON__NODE__NODE2__ENDPOINT__1__IPHL, PROTON__NODE__NODE2__ENDPOINT__1__PORT, false);
...
int main()
{
  ...
  proton_peer_t node3_peers[PROTON__PEER__COUNT] = {
    PROTON__NODE__NODE1__PEER__DEFAULT_VALUE, PROTON__NODE__NODE2__PEER__DEFAULT_VALUE};
