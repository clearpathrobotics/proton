...
proton_status_e proton_node_node2_transport_connect(void* context) {
  ...
  c->sock_recv = socket_init(PROTON__NODE__NODE1__ENDPOINT__0__IPHL,
                             PROTON__NODE__NODE1__ENDPOINT__0__PORT, true);
  c->sock_send = socket_init(PROTON__NODE__NODE2__ENDPOINT__0__IPHL,
                             PROTON__NODE__NODE2__ENDPOINT__0__PORT, false);
...
int main() {
  ...
  context_t context = {.node = &node1_node,
