...
proton_status_e proton_node_node1_transport_connect(void* context) {
  context_t* c = (context_t*)context;
  c->sock1_recv = socket_init(PROTON__NODE__NODE2__ENDPOINT__0__IPHL,
                              PROTON__NODE__NODE2__ENDPOINT__0__PORT, true);
  c->sock1_send = socket_init(PROTON__NODE__NODE1__ENDPOINT__0__IPHL,
                              PROTON__NODE__NODE1__ENDPOINT__0__PORT, false);
 ...
 */
proton_status_e
proton_node_node1_transport_read(void* context, uint8_t* buf, size_t len, size_t* bytes_read) {
  context_t* c = (context_t*)context;
 ...
 * @return proton_status_e Status of the operation
 */
proton_status_e proton_node_node1_transport_write(void* context, const uint8_t* buf, size_t len,
...
proton_status_e proton_node_node3_transport_connect(void* context) {
  context_t* c = (context_t*)context;
  c->sock3_recv = socket_init(PROTON__NODE__NODE2__ENDPOINT__1__IPHL,
                              PROTON__NODE__NODE2__ENDPOINT__1__PORT, true);
  c->sock3_send = socket_init(PROTON__NODE__NODE3__ENDPOINT__1__IPHL,
                              PROTON__NODE__NODE3__ENDPOINT__1__PORT, false);
 ...
 */
proton_status_e
proton_node_node3_transport_read(void* context, uint8_t* buf, size_t len, size_t* bytes_read) {
  context_t* c = (context_t*)context;
 ...
 * @return proton_status_e Status of the operation
 */
proton_status_e proton_node_node3_transport_write(void* context, const uint8_t* buf, size_t len,
                                                  size_t* bytes_written) {
  context_t* c = (context_t*)context;
...
void* timer_1hz(void* arg) {
  ...
  while (1) {
    ...
    if (time(NULL) - context->last_node1_heartbeat >
        PROTON__NODE__NODE2__HEARTBEAT__PERIOD / 1000) {
      context->node->peers[PROTON__PEER__NODE1].state = PROTON_NODE_INACTIVE;
    }

    if (time(NULL) - context->last_node3_heartbeat >
        PROTON__NODE__NODE3__HEARTBEAT__PERIOD / 1000) {
...
void* stats(void* arg) {
  ...
  while (1) {
    ...
    printf("  State: %u, Transport: %u\r\n", context->node->peers[PROTON__PEER__NODE1].state,
           context->node->peers[PROTON__PEER__NODE1].transport.state);
    ...
    printf("  State: %u, Transport: %u\r\n", context->node->peers[PROTON__PEER__NODE3].state,
           context->node->peers[PROTON__PEER__NODE3].transport.state);
...
int main() {
  ...
  proton_peer_t node2_peers[PROTON__PEER__COUNT] = {PROTON__NODE__NODE1__PEER__DEFAULT_VALUE,
  ...
  context_t context = {.node = &node2_node,
  ...
  strncpy(context.bundles.node_name_bundle.name, PROTON__NODE__NODE2__NAME,
          PROTON__BUNDLE__NODE_NAME__SIGNAL__NAME__CAPACITY);
