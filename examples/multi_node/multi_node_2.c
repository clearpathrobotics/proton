...
{
  context_t * c = (context_t *)context;
  c->sock1_recv = socket_init(
    PROTON__NODE__NODE2__ENDPOINT__0__IPHL, PROTON__NODE__NODE2__ENDPOINT__0__PORT, true);
  c->sock1_send = socket_init(
    PROTON__NODE__NODE1__ENDPOINT__0__IPHL, PROTON__NODE__NODE1__ENDPOINT__0__PORT, false);
 ...
 * @return proton_status_e Status of the operation
 */
proton_status_e proton_node_node1_transport_read(
 ...
 * @return proton_status_e Status of the operation
 */
proton_status_e proton_node_node1_transport_write(
...
{
  context_t * c = (context_t *)context;
  c->sock3_recv = socket_init(
    PROTON__NODE__NODE2__ENDPOINT__1__IPHL, PROTON__NODE__NODE2__ENDPOINT__1__PORT, true);
  c->sock3_send = socket_init(
    PROTON__NODE__NODE3__ENDPOINT__1__IPHL, PROTON__NODE__NODE3__ENDPOINT__1__PORT, false);
 ...
 * @return proton_status_e Status of the operation
 */
proton_status_e proton_node_node3_transport_read(
  void * context, uint8_t * buf, size_t len, size_t * bytes_read)
{
  context_t * c = (context_t *)context;
 ...
 * @return proton_status_e Status of the operation
 */
proton_status_e proton_node_node3_transport_write(
  void * context, const uint8_t * buf, size_t len, size_t * bytes_written)
{
  context_t * c = (context_t *)context;
...
int main()
{
  ...
  proton_peer_t node2_peers[PROTON__PEER__COUNT] = {
    PROTON__NODE__NODE1__PEER__DEFAULT_VALUE, PROTON__NODE__NODE3__PEER__DEFAULT_VALUE};
  ...
  strncpy(
    context.bundles.node_name_bundle.name, PROTON__NODE__NODE2__NAME,
